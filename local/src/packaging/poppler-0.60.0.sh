...
local pkgconfigdir="${INSTALL_TARGET}/lib/pkgconfig"
	...
	cat <<EOS > "${pkgconfigdir}/poppler.pc" &&
...
EOS
	...
	cat <<EOS > "${pkgconfigdir}/poppler-cairo.pc" &&
prefix=${INSTALL_TARGET}
exec_prefix=\${prefix}
libdir=\${exec_prefix}/lib
includedir=\${prefix}/include
...
EOS
	...
	cat <<EOS > "${pkgconfigdir}/poppler-cpp.pc"
prefix=${INSTALL_TARGET}
exec_prefix=\${prefix}
libdir=\${exec_prefix}/lib
includedir=\${prefix}/include
...
EOS
	...
	cat <<EOS > "${pkgconfigdir}/poppler-glib.pc" &&
prefix=${INSTALL_TARGET}
exec_prefix=\${prefix}
libdir=\${exec_prefix}/lib
includedir=\${prefix}/include
...
EOS
	...
	cat <<EOS > "${pkgconfigdir}/poppler-splash.pc"
prefix=${INSTALL_TARGET}
exec_prefix=\${prefix}
libdir=\${exec_prefix}/lib
includedir=\${prefix}/include
