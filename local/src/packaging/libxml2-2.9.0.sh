...
run_pack_archive() {
	...
	pack_archive "${DEVZIP}" bin/*-config include lib/*.{def,a} lib/xml2Conf.sh lib/pkgconfig share/man/man1/xml2-config.1 share/man/man3 share/{aclocal,doc,gtk-doc} &&
	pack_archive "${TOOLSZIP}" bin/*.{exe,manifest,local} share/man/man1/xml{catalog,lint}.1 &&
