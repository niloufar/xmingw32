...
run_configure() {
	cd build/linux &&
	${XMINGW}/cross-cmake -G "Unix Makefiles" ../../source -DALLOW_IN_SOURCE_BUILD:bool=true -DCMAKE_BUILD_TYPE:string=RELEASE -DCMAKE_INSTALL_PREFIX:string="${INSTALL_TARGET}" \
